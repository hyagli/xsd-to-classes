...
namespace CodeGeneration.ImporterExtensions
{
    ...
    {
        Dictionary<XmlSchemaType, string> generatedTypes = new Dictionary<XmlSchemaType, string>();
        ...
        Type XsdToClrPrimitive(XmlQualifiedName qname)
        {
            ...
            throw new InvalidOperationException(string.Format("Cannot map XSD type '{0}' to CLR primitive type.", qname));
        }
