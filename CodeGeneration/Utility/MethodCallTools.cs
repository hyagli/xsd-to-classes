...
namespace CodeGeneration
{
    ...
    public static class MethodCallTools
    {
        ...
        public class NameGenerator
        {
            ...
            /// </summary>
            /// <returns></returns>
            public string GetName() { return m_baseName + (m_number++).ToString(); }
            ...
            /// </summary>
            /// <returns></returns>
            public static string GenerateName() { return m_nameGenerator.GetName(); }
        ...
        public static object[] XmlToMethodInput(MethodInfo methodInfo, Type type, XmlDocument document)
        {
            ...
            StringReader sr = new StringReader(document.OuterXml);
            object obj = deserializer.Deserialize(sr);

            // get non-output parameters
            List<ParameterInfo> nonOutputParameters = new List<ParameterInfo>();
            nonOutputParameters = GetNonOutputParameters(methodInfo);
        ...
        public static Type CreateTypeFromParameters(List<ParameterInfo> parameters, MethodInfo methodInfo)
        {
            ...
            try
            {
                ...
                myAsmName.Name = "TemporaryTypeAssembly";
