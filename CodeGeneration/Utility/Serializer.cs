    ...
    public static class Serializer
    {
        ...
        public static XmlElement SerializeToElement<T>(T obj, Type[] types) where T : class
        {
            try
            {
                ...
                XmlElement element = (XmlElement)doc.DocumentElement;

                // the below method creates another node encapsulating the actual XmlElement
                // this is sub-optimal. Doing it this way requires us to deserialize the InnerXML
                // and makes the XML more wordy
