...
namespace CodeGeneration
{
    ...
    public class Utility
    {
        ...
        {
            return (type.IsPrimitive ? true : IsPrimitive(type.FullName));
        }
        ...
        /// </summary>
        static Stack<Type> m_instantiatedTypes = new Stack<Type>();
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        internal static bool IsNullable(string type)
        {
            return (type == "System.Nullable`1");
        }
        ...
        {
            return (IsNullable(elementType.BaseType)) ? GetNullableTypeName(elementType) + "?" : elementType.BaseType;
        }
        ...
        {
            return Utility.GetValidCSharpIdentifier(GetCollectionContainedType(elementType) + "Collection");
        }
        ...
        {
            return elementType.TypeArguments[0].BaseType;
        }
