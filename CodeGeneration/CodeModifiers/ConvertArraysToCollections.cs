...
namespace CodeGeneration.CodeModifiers
{
    ...
    {
        ConvertArraysToCollectionsOptions m_options = null;

        public ConvertArraysToCollections()
        {
        ...
        /// </summary>
        public ConvertArraysToCollectionsOptions Options
        {
            get 
            {
                if (m_options == null)
                    m_options = GetOptions<ConvertArraysToCollectionsOptions>();
                return m_options; 
            }
        }
