...
namespace BlueToque.XsdToClasses.VisualStudio
{
        ...
        IVsSingleFileGenerator
    {
        ...
        protected string FileNameSpace { get { return codeFileNameSpace; } }

        /// <summary> file-path for the input file. </summary>
        protected string InputFilePath { get { return codeFilePath; } }

        /// <summary>
        /// interface to the VS shell object we use to tell our
        /// progress while we are generating.
        /// </summary>
        internal IVsGeneratorProgress CodeGeneratorProgress { get { return codeGeneratorProgress; } }
