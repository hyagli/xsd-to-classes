...
namespace XsdToClasses.VisualStudio
{
	/// <summary>
	...
	public class Site : ISite
	{
        ...
        /// <summary>See <see cref="ISite.Component"/>.</summary>
		public IComponent Component { get { return _component; } } 
        
		/// <summary>See <see cref="ISite.Container"/>.</summary>
		public IContainer Container { get { return _container; } } 

		/// <summary>Always returns <c>false</c>.</summary>
		public bool DesignMode { get { return false; } } 

		/// <summary>See <see cref="ISite.Name"/>.</summary>
		public string Name
		{
			get { return _name; }
			set { _name = value; }
		...
		/// <summary>See <see cref="IServiceProvider.GetService"/>.</summary>
